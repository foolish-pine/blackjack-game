...
describe("checkPlayersHand", () => {
  describe("正常系", () => {
    it("手札の枚数が2枚かつその数字の合計が21のときのみ'blackjack'を返す", () => {
      expect(checkPlayersHand([10, 11])).to.equal("blackjack");
      expect(checkPlayersHand([2, 8, 11])).to.equal("result");
    });
    ...
    it("手札の数字の合計が21以上かつ11が含まれるとき、11を1とみなして判定する", () => {
